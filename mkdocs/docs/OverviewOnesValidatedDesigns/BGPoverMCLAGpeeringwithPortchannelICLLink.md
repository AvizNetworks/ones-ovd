# <b>BGP over MC-LAG peering with Port channel ICL Link</b>

Layer 3 MC-LAG extends the capabilities of MC-LAG to Layer 3 routing. In a Layer 3 MC-LAG configuration, the MC-LAG peers can perform routing functions, allowing for better scalability and flexibility in managing IP subnets and routing within the network.

<b> L3 MC LAG Functions:</b>
...
<b> Layer 3 Extension:</b>
- In a Layer 3 MC-LAG setup, the MLAG peers are capable of performing Layer 3 routing functions.
- This means they can route IP traffic between different subnets, extending the MC-LAG benefits to Layer 3.

<b> Benefits: </b>
- High Availability: If one of the MLAG peers fails, the other can seamlessly take over, ensuring network continuity.
- Load Balancing: Both peers actively participate in handling traffic, distributing the load and preventing bottlenecks.
- Scalability: Layer 3 MC LAG allows for efficient scaling of IP subnets and routing capabilities.
